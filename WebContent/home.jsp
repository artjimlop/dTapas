	...
	<div id="div_contain">
		...
		<div id="div_body">
			...
			<div id="div_user_space">
				...
				<h3 id="title_space_user" class="blue_underline">Últimas acciones</h3>
				...
				<div id="div_ar_contain">
					<div>Presentación: <%= representationActivity.getPresentationScore() %></div>
				...
				<div id="div_ar_contain">
					...
					<div>Localización: <%= representationActivity.getLocationScore() %></div>
				...
				<%
					...
					}else{ //Se cumple si el usuario aún no ha creado ninguna actividad
						out.println("El tapeador aún no ha realizado ninguna actividad.");
					}
				%>
